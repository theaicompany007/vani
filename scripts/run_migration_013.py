"""Python script to run migration 013 via Supabase"""
import os
import sys
...
# Read SQL file
sql_file = project_root / 'app' / 'migrations' / '013_add_contact_company_use_cases.sql'
...
try:
    ...
    if database_url:
        try:
            ...
            cur.close()
            conn.close()
            print('✅ Migration 013 executed successfully via direct database connection!')
            sys.exit(0)
        except ImportError:
